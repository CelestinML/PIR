...
public class Billiev1 : MonoBehaviour
{
    ...
    void computeMovement()
    {
        ...
        for (int i = 0; i < 6; ++i)
        {
            ...
            if (next_obstacles[i] == false)
            {
                ...
                //That condition is useful to come back to middle when possible
                if ((i == 2 || i == 3) && score <= 2)
                {
                    if (actual_position < i)
                    {
                        if (next_obstacles[actual_position + 1])
                        {
                            // We abandon the idea of going to 2 or 3, as there is an obstacle beetween us.
                            continue;
                        }
                    }
                    else
                    {
                        if (actual_position > i)
                        {
                            if (next_obstacles[actual_position - 1])
                            {
                                // Same as before, but coming from right side
                                continue;
                            }
                        }
                    }
